...
router.get('/update-contact/:id',DisplayUpdateContactPage);

router.post('/update-contact/:id',ProcessUpdateContactPage);

router.get('/delete-contact/:id',ProcessDeleteContactPage);
